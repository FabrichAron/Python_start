...
# map(function, iterables) == for

# reduce == SUM(a + b + c + . . .)

# filter == filter(function, iterable) (function return boolean)

# ziplash == bir vaqtda 2 va undan ortiq ro'yhatlarda sikl aylantirish

# assert == Test uchun ishlatiladi. Tengmi yoki teng emasmi tekshiradi.